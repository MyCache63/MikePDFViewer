...
#ifndef MIKEPDFVIEWERKIT_SWIFT_H
#define MIKEPDFVIEWERKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MikePDFViewerKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16MikePDFViewerKit17EMLToPDFConverter")
@interface EMLToPDFConverter : NSObject
...
SWIFT_CLASS("_TtC16MikePDFViewerKit17HTMLToPDFRenderer")
@interface HTMLToPDFRenderer : NSObject <WKNavigationDelegate>
